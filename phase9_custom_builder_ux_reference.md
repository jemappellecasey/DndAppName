# Phase 9 Custom Builder UX Reference

## Implemented endpoints
1. `GET /custom/builders/origin/guidance`
2. `GET /custom/builders/species/guidance`
3. `POST /custom/builders/origin/preview`
4. `POST /custom/builders/species/preview`
